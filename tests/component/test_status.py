...
def test_check_ping():
    ...
    response = httpx.get(f"http://test-core-svc.{KUBE_NAMESPACE}.svc.{CLUSTER_DOMAIN}:8080/v1/ping")  # noqa: E231
...
def test_check_health():
    ...
    response = httpx.get(f"http://test-core-svc.{KUBE_NAMESPACE}.svc.{CLUSTER_DOMAIN}:8080/v1/health")  # noqa: E231
