...
K8S_CHART_PARAMS += $(K8S_CHART_COMMON_PARAMS) \
	...
	--set svc.api.image.registry=registry.gitlab.com/ska-telescope/src/src-service-apis/$(CI_PROJECT_NAME) \
...
# Override pre for oci-build (oci.mk): Check if branch is behind origin/main
oci-pre-build-all:
