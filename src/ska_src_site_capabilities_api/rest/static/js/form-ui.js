                  ...
                  "items": [
                    {
                      ...
                      "items": [
                        {
                          "key": "compute[].associated_local_services[].id"
                        },
                        {
                          "key": "compute[].associated_local_services[].type",
                          "valueInLegend": true
                        },
                        {
                          "key": "compute[].associated_local_services[].version",
                          "placeholder": "The version of this service"
                        },
                        {
                          "key": "compute[].associated_local_services[].prefix",
                          "placeholder": "The prefix for this service (if applicable)"
                        },
                        {
                          "key": "compute[].associated_local_services[].host",
                          "placeholder": "The hostname for this service excluding prefix and path (if applicable)"
                        },
                        {
                          "key": "compute[].associated_local_services[].port",
                          "placeholder": "The port for this service (if applicable)"
                        },
                        {
                          "key": "compute[].associated_local_services[].path",
                          "placeholder": "The path for this service (if applicable)"
                        },
                        {
                          "key": "compute[].associated_local_services[].associated_storage_area_id",
                          "placeholder": "Associated storage area ID (if applicable)"
                        },
                        {
                          "key": "compute[].associated_local_services[].identifier",
                          "placeholder": "A name used to identify this service"
                        },
                        {
                          "key": "compute[].associated_local_services[].is_mandatory",
                          "notitle": true,
